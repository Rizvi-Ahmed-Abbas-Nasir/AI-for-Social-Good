...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.Pages.add(" Home ")
        self.Pages.add(" AI Vision Trainer ")
        self.Pages.add(" AI Gesture PPT ")
        self.Pages.add(" Hand Sign Language ")
        self.Pages.add(" Hand Sign using Words ")
        self.Pages.add(" Fire Detection ")
        ...
        self.HomeLabel1 = customtkinter.CTkLabel(self.Pages.tab(" Home "), text=" For Social Good",
                                                 font=customtkinter.CTkFont(family="IBM Plex Sans", size=30),
                                                 corner_radius=10)
        self.HomeLabel1.place(x=155, y=78)

        self.HomeLabel2 = customtkinter.CTkLabel(self.Pages.tab(" Home "), text=" Hand Crafted AI/ML Modules Integrated.",
        ...
        # Label Trainer
        self.HomeLabel__2 = customtkinter.CTkLabel(self.Pages.tab(" AI Vision Trainer "),
                                                 text="Trainer",
        ...
        # Image Trainer
        self.HomeLabel__3 = customtkinter.CTkLabel(self.Pages.tab(" AI Vision Trainer "),
                                                 text=" ",
                                                 image=ImageHome1,
                                                 font=customtkinter.CTkFont(family="IBM Plex Sans", size=25),
                                                 corner_radius=0)
        ...
        # Desktop Trainer
        self.button__1 = customtkinter.CTkButton(self.Pages.tab(" AI Vision Trainer "),
                                                corner_radius=100,
                                                text="Start",
                                                command=self.open_SitsUpsApp)
        self.button__1.place(x=110, y=350)

        self.HomeLabel__6 = customtkinter.CTkLabel(self.Pages.tab(" AI Vision Trainer "),
                                                   text=" ",
                                                   image=ImageHome1_1,
                                                   font=customtkinter.CTkFont(family="IBM Plex Sans", size=25),
                                                   corner_radius=0)
        ...
        # Desktop Trainer
        self.button__5 = customtkinter.CTkButton(self.Pages.tab(" AI Vision Trainer "),
                                                 corner_radius=100,
                                                 text="Start",
        ...
        # TextBox Trainer
        self.textbox2 = customtkinter.CTkTextbox(self.Pages.tab(" AI Vision Trainer "), width=350, height=240)
        self.textbox2 = customtkinter.CTkTextbox(self.Pages.tab(" AI Vision Trainer "), width=350, height=240)
        self.textbox2 = customtkinter.CTkTextbox(self.Pages.tab(" AI Vision Trainer "), width=350, height=240)
        ...
        self.HomeLabel__4 = customtkinter.CTkLabel(self.Pages.tab(" AI Gesture PPT "),
        ...
        self.HomeLabel__5 = customtkinter.CTkLabel(self.Pages.tab(" AI Gesture PPT "),
                                                   text=" ",
                                                   image=ImageHome3,
                                                   font=customtkinter.CTkFont(family="IBM Plex Sans", size=25),
                                                   corner_radius=0)
        ...
        self.button__4 = customtkinter.CTkButton(self.Pages.tab(" AI Gesture PPT "),
                                                 corner_radius=100,
                                                 text="Start",
        ...
        self.textbox4 = customtkinter.CTkTextbox(self.Pages.tab(" AI Gesture PPT "), width=350, height=240)
        self.textbox4 = customtkinter.CTkTextbox(self.Pages.tab(" AI Gesture PPT "), width=350, height=240)
